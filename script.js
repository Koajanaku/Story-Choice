...
rightRightLeft.style.display= "none";
...
leftRight.addEventListener('click', function(){
});
leftRightEnd.addEventListener('click', function(){
});
leftLeft.addEventListener('click', function(){
});
leftLeftEnd.addEventListener('click', function(){
});
right.addEventListener('click', function(){
});
rightRight.addEventListener('click', function(){
});
rightRightEnd.addEventListener('click', function(){
});
rightLeft.addEventListener('click', function(){
});
rightLeftEnd.addEventListener('click', function(){
});
